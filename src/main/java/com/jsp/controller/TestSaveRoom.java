...
public class TestSaveRoom {
	public static void main(String[] args) {
		Room room1 = new Room();
		room1.setRoom_price(2050.00);
		room1.setRoom_status("AVAILABLE");

		Room room2 = new Room();
		room2.setRoom_price(1550.00);
		room2.setRoom_status("AVAILABLE");

		Room room3 = new Room();
		room3.setRoom_price(3080.00);
		...
		Room room7 = new Room();
		room7.setRoom_price(2220.00);
		room7.setRoom_status("AVAILABLE");

		Room room8 = new Room();
		room8.setRoom_price(2500.00);
		room8.setRoom_status("AVAILABLE");

		Room room9 = new Room();
		room9.setRoom_price(3750.00);
